...
regularFunctionName
    ...
    | CURRENT_DATE | CURRENT_TIME | UTC_TIMESTAMP | MBRCONTAINS | MBRCOVEREDBY | MBRCOVERS | MBRDISJOINT | MBREQUALS | MBRINTERSECTS | MBROVERLAPS | MBRTOUCHES | MBRWITHIN | identifier
    ;
